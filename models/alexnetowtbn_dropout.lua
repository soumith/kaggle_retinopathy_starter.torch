function createModel(nGPU)
   ...
   features:add(cudnn.SpatialConvolution(64,192,3,3,2,2,1,1))       --  27 -> 27
   ...
   features:add(nn.Dropout(0.5)) -- dropout here gets us 0.39453
   ...
   classifier:add(nn.View(256*2*2))
   ...
   for i=1,nGPU do
      ...
      s:add(nn.Linear(256*2*2, 4096/nGPU))
